...
func Test_makeAnnotations_NoKeys(t *testing.T) {
	annotationVal := `{"name":"","image":"","replicas":null,"handler":"","annotations":null,"labels":null,"environment":null,"envFrom":null,"constraints":null,"secrets":null,"limits":null,"requests":null,"readOnlyRootFilesystem":false}`
...
func Test_makeAnnotations_WithKeyAndValue(t *testing.T) {
	annotationVal := `{"name":"","image":"","replicas":null,"handler":"","annotations":{"key":"value","key2":"value2"},"labels":null,"environment":null,"envFrom":null,"constraints":null,"secrets":null,"limits":null,"requests":null,"readOnlyRootFilesystem":false}`
...
func Test_makeAnnotationsDoesNotModifyOriginalSpec(t *testing.T) {
	...
	expectedAnnotations := map[string]string{
		...
		"test.foo":             "bar",
		annotationFunctionSpec: `{"name":"testfunc","image":"","replicas":null,"handler":"","annotations":{"test.foo":"bar"},"labels":null,"environment":null,"envFrom":null,"constraints":null,"secrets":null,"limits":null,"requests":null,"readOnlyRootFilesystem":false}`,
	}
